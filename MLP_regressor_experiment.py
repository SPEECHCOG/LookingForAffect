...
if __name__ == "__main__":
    ...
    for feature_df in feature_dfs:
        for column in feature_df.columns:
            ...
            zeroes_in_dim = (feature_df[column] == 0).sum().item()
            if zeroes_in_dim / 12000 < 0.40:
    ...
    if coll:
        ...
        results_dir = args.data_dir+"/results_coll_valence_"+str(args.seed)+"/"
            
    else: 
        
        results_dir = args.data_dir+"/results_noncoll_valence_"+str(args.seed)+"/"
